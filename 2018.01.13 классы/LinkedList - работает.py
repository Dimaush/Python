...
class LinkedList:
    ...
    def elem (self, k, func):
        #if k == 0:
            #if func == 'insert': self.pushleft (data)
            #else: self.popleft ()
        #else:
            #if func == 'insert':
                #n = Node ()
            ...
            #t1 = self.head
            #if t1 == None:
                #if func == 'insert': print ("Error: the list's length is not enough to append data.")
                #else: print ("Error: the list's length is not enough to delete data.")
            #else:
                #flag = 0
                #t2 = t1.next_
                #for i in range (k - 1):
    ...
    def insert (self, k, data):
        if k == 0: self.pushleft (data)
            ...
            #n.data = data
            #t1 = self.head
            #if t1 == None: print ("Error: the list's length is not enough to append data.")
            #else:
                #flag = 0
                #t2 = t1.next_
                #for i in range (k - 1):
                    #if t2.next_ == None:
                        #print ("Error: the list's length is not enough to append data.")
                        #flag = 1
                        #break
                    #else: t1, t2 = t1.next_, t2.next_
                #if flag == 0:
    ...
    def delete (self, k):
        if k == 0: self.popleft ()
            ...
            #t1 = self.head
                ...
                #for i in range (k - 1):
                    #if t2.next_ == None:
                        #print ("Error: the list's length is not enough to delete data.")
                        #flag = 1
                        #break
                    #else: t1, t2 = t1.next_, t2.next_
                #if flag == 0:
